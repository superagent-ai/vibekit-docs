...
### `sessionId` (required)
- **Type:** `string`
- **Description:** The session ID to set for the sandbox environment
- **Format:** Must be a valid session identifier from a previously created session

## Return Value

Returns `Promise<void>`:
- **Type:** `void`
- **Description:** This method doesn't return a value but resolves when the session is successfully set
